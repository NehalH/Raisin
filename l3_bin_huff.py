...
percentage_compression, original_size, compressed_size, magnitude_compression = huffman_encode('l2_huffen_bin.txt', 'l3_huffen_bin.txt')
print('////////')
...
print('////////')
rle.run_length_encoding('l3_huffen_bin.txt', 'rle_bin.txt')
print('////////')
